...
# Logo (change path)
Logo = Image.open(r"C:\Users\skyla\Desktop\Assist\Assistente-UI\Versions\1.1\Image\unknown.png")
...
def Valcol():
    ...
    chlbl = Label(ardcol,bg= '#1a1818', fg= "white", text= "Configurations:  ", font= 'arial 15 bold')
    ...
    actkey = Label(ardcol,bg= '#1a1818', fg= "white", text= "Key in integer (162):  ", font= 15)
    actkey.grid(column=0, row=2, sticky = 'w')

    global actlist
    actlist = Listbox(ardcol, height=7)
    actlist.grid(column=0, row= 3)
    actlist.insert("end", "R_CTRL","VK_LBUTTON","VK_RBUTTON","VK_TAB","VK_LSHIFT","VK_LMENU(alt)")
    '''btna = Button(ardcol,text="Get", command=save)
